...
public class CreditsServiceImpl implements CreditsService{
    ...
    public AirtimeTopupResponse credit(final AirtimeTopupRequest airtimeTopupRequest) {
        ...
        final SubscriberRequest createdSubscriberRequest = subscriberRequestDao.save(subscriberRequest);//changed to save from persist
        ...
        subscriberRequestDao.save(createdSubscriberRequest);//changed to save from update
